...
if(!isset($_POST["interest"])){
    ...
    if($stmt = $mysqli->prepare("SELECT * FROM event WHERE DATEDIFF(start_time,NOW()) > -1 AND event_id IN (SELECT event_id FROM events WHERE group_id IN (SELECT group_id FROM about WHERE interest_name LIKE".$_POST["interest"]."))")){
